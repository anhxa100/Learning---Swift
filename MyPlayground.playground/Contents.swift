...
class CustomView: UIView, CAAnimationDelegate {
    ...
    func setupLayers(){
        ...
        rectangle.frame = CGRect(x: 29.46, y: 37.27, width: 23, height: 18)
        rectangle.path = rectanglePath().cgPath
        self.layer.addSublayer(rectangle)
        layers["rectangle"] = rectangle
        
        let rectangle2 = CAShapeLayer()
        rectangle2.frame = CGRect(x: 41.46, y: 49.27, width: 17.08, height: 11.23)
        ...
        rectangle3.frame = CGRect(x: 47.54, y: 34.27, width: 23, height: 18)
    ...
    func resetLayerProperties(forLayerIdentifiers layerIds: [String]!){
        ...
        if layerIds == nil || layerIds.contains("rectangle"){
            ...
            rectangle.fillColor   = UIColor(red:0.937, green: 0.937, blue:0.937, alpha:1).cgColor
    ...
    func addUntitled1Animation(completionBlock: ((_ finished: Bool) -> Void)? = nil){
        ...
        rectanglePositionAnim.values         = [NSValue(cgPoint: CGPoint(x: 40.962, y: 46.266)), NSValue(cgPoint: CGPoint(x: 0, y: 0))]
        rectanglePositionAnim.keyTimes       = [0, 1]
        rectanglePositionAnim.duration       = 4
        rectanglePositionAnim.timingFunction = CAMediaTimingFunction(controlPoints: 0.596, -0.0204, 0.319, 1.01)
        
        let rectangleUntitled1Anim : CAAnimationGroup = QCMethod.group(animations: [rectanglePositionAnim], fillMode:fillMode)
        layers["rectangle"]?.add(rectangleUntitled1Anim, forKey:"rectangleUntitled1Anim")
        
        ////Rectangle2 animation
        let rectangle2PositionAnim      = CAKeyframeAnimation(keyPath:"position")
        rectangle2PositionAnim.values   = [NSValue(cgPoint: CGPoint(x: 50, y: 54.883)), NSValue(cgPoint: CGPoint(x: 100, y: 160))]
        rectangle2PositionAnim.keyTimes = [0, 1]
        rectangle2PositionAnim.duration = 4
        
        let rectangle2Untitled1Anim : CAAnimationGroup = QCMethod.group(animations: [rectangle2PositionAnim], fillMode:fillMode)
        layers["rectangle2"]?.add(rectangle2Untitled1Anim, forKey:"rectangle2Untitled1Anim")
        
        ////Rectangle3 animation
        let rectangle3PositionAnim      = CAKeyframeAnimation(keyPath:"position")
        rectangle3PositionAnim.values   = [NSValue(cgPoint: CGPoint(x: 59.038, y: 43.266)), NSValue(cgPoint: CGPoint(x: -49, y: 180))]
        rectangle3PositionAnim.keyTimes = [0, 1]
        rectangle3PositionAnim.duration = 4
        
        let rectangle3Untitled1Anim : CAAnimationGroup = QCMethod.group(animations: [rectangle3PositionAnim], fillMode:fillMode)
        layers["rectangle3"]?.add(rectangle3Untitled1Anim, forKey:"rectangle3Untitled1Anim")
    }
    ...
    func updateLayerValues(forAnimationId identifier: String){
        if identifier == "Untitled1"{
            ...
            QCMethod.updateValueFromPresentationLayer(forAnimation: layers["rectangle3"]!.animation(forKey: "rectangle3Untitled1Anim"), theLayer:layers["rectangle3"]!)
        }
    }
    ...
    func removeAnimations(forAnimationId identifier: String){
        if identifier == "Untitled1"{
            ...
            layers["rectangle3"]?.removeAnimation(forKey: "rectangle3Untitled1Anim")
        }
    }
    ...
    func rectanglePath() -> UIBezierPath{
        let rectanglePath = UIBezierPath(rect:CGRect(x: 0, y: 0, width: 23, height: 18))
        return rectanglePath
    }
    
    func rectangle2Path() -> UIBezierPath{
        let rectangle2Path = UIBezierPath(rect:CGRect(x: 0, y: 0, width: 17, height: 11))
        return rectangle2Path
    }
    
    func rectangle3Path() -> UIBezierPath{
        let rectangle3Path = UIBezierPath(rect:CGRect(x: 0, y: 0, width: 23, height: 18))
